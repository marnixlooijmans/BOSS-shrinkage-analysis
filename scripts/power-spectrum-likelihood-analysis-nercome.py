...
if __name__ == "__main__":
    ...
    sampler.run_mcmc(start, nsteps, callbacks=zeus.callbacks.SaveProgressCallback("../output/NERCOME_" + str(nmocks) + "_chain.h5", ncheck=50))

    chain = sampler.get_chain(flat=False)
    np.save("../output/NERCOME_" + str(nmocks) + "_chain.npy", chain)
