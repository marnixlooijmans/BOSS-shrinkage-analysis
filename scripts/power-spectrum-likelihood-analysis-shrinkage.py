...
class PowerSpectrumLikelihood():
    ...
    def __init__(self, nmocks):
        ...
        cov = pk_tools.read_matrix(datapath + "BOSS_DR12_NGC_z1_cov/BOSS_DR12_NGC_z1_cov_30_30_shrinkage_" + str(nmocks) + ".matrix")
...
if __name__ == "__main__":
    ...
    sampler.run_mcmc(start, nsteps, callbacks=zeus.callbacks.SaveProgressCallback("../output/shrinkage_" + str(nmocks) + "_chain.h5", ncheck=50))

    chain = sampler.get_chain(flat=False)
    np.save("../output/shrinkage_" + str(nmocks) + "_chain.npy", chain)
